...
const StatusBlock = ({
  ...
  const options: any = {
    ...
    plotOptions: {
      bar: { columnWidth: "60%", barHeight: "100%" },
    },
  ...
  return (
    <Card className={cn("", className)}>
      <CardContent className="p-4">
        <div className={cn("flex gap-3", { "flex-row-reverse": reverse })}>
          {icon && (
        ...
        <div className="ms-auto max-w-[124px]">
          <Chart options={options} series={chartSeries} type={chartType} height={41} width={124} />
        </div>
      </CardContent>
    </Card>
  );
