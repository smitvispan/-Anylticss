                ...
                <div className="flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-1 text-base text-slate-700">
                            Fill in login access and assign the channels this user should land on first.
                        </p>
                    </div>
                    <span className="rounded-full bg-sky-600 px-3 py-1 text-xs font-semibold text-white shadow-sm">New user</span>
                </div>
            </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="inline-flex items-center justify-center rounded-xl bg-sky-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-sky-200 transition hover:-translate-y-0.5 hover:bg-sky-700 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            {loading && <Icon icon="lucide:loader-2" className="mr-2 h-4 w-4 animate-spin" />}
